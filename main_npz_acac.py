...
import datasets.pyg.npz_acac as md17_dataset
...
def main(args):
    ...
    # as val split not in acac data --> using same split as val to avoid changing code # later remove or create val split                
    val_dataset = md17_dataset.get_md17_datasets(args.data_path  + "test")
